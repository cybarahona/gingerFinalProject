...
public class FragmentoPerfil extends Fragment {
    ...
    public static FragmentoPerfil newInstance() {
    ...
    private void firebaseAuthWithGoogle(GoogleSignInAccount acct) {
        ...
        mFirebaseAuth.signInWithCredential(credential)
                .addOnCompleteListener(FragmentoPerfil.this.getActivity(),new OnCompleteListener<AuthResult>() {
                            @Override
                            public void onComplete(@NonNull Task<AuthResult> task) {
                        String message;
                        if (task.isSuccessful()) {
    ...
    private void initFBTwitterLogIn() {
        ...
        Fabric.with(FragmentoPerfil.this.getContext(), new Twitter(authConfig));
    }
